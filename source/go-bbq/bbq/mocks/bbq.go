...
// Source: github.com/ssargent/go-bbq/bbq (interfaces: DeviceRepository,MonitorRepository,DeviceService,MonitorService)
...
func (m *MockDeviceRepository) Create(arg0 Device) (Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceRepository) Delete(arg0 Device) error {
	m.ctrl.T.Helper()
...
func (m *MockDeviceRepository) GetByTenantID(arg0 uuid.UUID) ([]Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceRepository) GetDevice(arg0 uuid.UUID, arg1 string) (Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceRepository) Update(arg0 Device) (Device, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method
func (m *MockMonitorRepository) Create(arg0 Monitor) (Monitor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0)
...
// Delete mocks base method
func (m *MockMonitorRepository) Delete(arg0 Monitor) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
func (m *MockMonitorRepository) GetByName(arg0 uuid.UUID, arg1 string) (Monitor, error) {
	m.ctrl.T.Helper()
...
// GetByTenantID mocks base method
func (m *MockMonitorRepository) GetByTenantID(arg0 uuid.UUID) ([]Monitor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByTenantID", arg0)
	ret0, _ := ret[0].([]Monitor)
	ret1, _ := ret[1].(error)
...
// Update mocks base method
func (m *MockMonitorRepository) Update(arg0 Monitor) (Monitor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", arg0)
	ret0, _ := ret[0].(Monitor)
	ret1, _ := ret[1].(error)
...
func (m *MockDeviceService) CreateDevice(arg0 uuid.UUID, arg1 Device) (Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceService) DeleteDevice(arg0 uuid.UUID, arg1 Device) error {
	m.ctrl.T.Helper()
...
// GetDevice mocks base method
func (m *MockDeviceService) GetDevice(arg0 uuid.UUID, arg1 string) (Device, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDevice", arg0, arg1)
	ret0, _ := ret[0].(Device)
	ret1, _ := ret[1].(error)
...
func (m *MockDeviceService) GetDevices(arg0 uuid.UUID) ([]Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceService) UpdateDevice(arg0 uuid.UUID, arg1 Device) (Device, error) {
	m.ctrl.T.Helper()
...
func (m *MockMonitorService) CreateMonitor(arg0 uuid.UUID, arg1 Monitor) (Monitor, error) {
	m.ctrl.T.Helper()
...
func (m *MockMonitorService) DeleteMonitor(arg0 uuid.UUID, arg1 Monitor) error {
	m.ctrl.T.Helper()
...
func (m *MockMonitorService) GetMonitor(arg0 uuid.UUID, arg1 string) (Monitor, error) {
	m.ctrl.T.Helper()
...
func (m *MockMonitorService) GetMonitors(arg0 uuid.UUID) ([]Monitor, error) {
	m.ctrl.T.Helper()
...
func (m *MockMonitorService) UpdateMonitor(arg0 uuid.UUID, arg1 Monitor) (Monitor, error) {
	m.ctrl.T.Helper()
